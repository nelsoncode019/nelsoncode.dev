      ...
      <div className="p-3 md:pl-64 h-screen hidden md:block">
        ...
        >
          <div>
            ...
            <br />
            <p>
              My love for web development has made me want to share it with the
              whole world, both videos recorded for Youtube and live talks.
            </p>
            <br />
            <p>
              Currently I am focused on the Frontend side but in my free time I
              use <strong>Python</strong> and do magic with{" "}
        ...
        >
          ...
          {Work ? (
            <div className="max-w-2xl">
              ...
              <br />
              <ul className="list-disc ml-4">
                <li>Web application to manage constructions.</li>
                <li>
                  I worked on the configuration part in the web app, so I had to
                  understand the model business quickly.
                </li>
                <li>We use React, Ant Design, PostgreSQL, Express JS.</li>
              </ul>
            </div>
          ) : (
            <div className="max-w-3xl">
              ...
              <br />
              <ul className="list-disc ml-4">
                <li>Web application to manage customs procedures.</li>
                <li>I wrote the entire application.</li>
                <li>
                  I used React, CSS Vanilla, MongoDB, Node JS, Websockets,
                  DigitalOcean.
                </li>
              </ul>
            </div>
